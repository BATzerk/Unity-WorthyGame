...
public static class LineUtils {
    ...
    public static Line GetLineCW(Rect rect, int side) {
        switch (side) {
            case Sides.U: return new Line(rect.xMin,rect.yMax, rect.xMax,rect.yMax);
            case Sides.R: return new Line(rect.xMax,rect.yMax, rect.xMax,rect.yMin);
            case Sides.D: return new Line(rect.xMax,rect.yMin, rect.xMin,rect.yMin);
    ...
    public static Line GetLineCCW(Rect rect, int side) {
        switch (side) {
            case Sides.U: return new Line(rect.xMax,rect.yMax, rect.xMin,rect.yMax);
            case Sides.R: return new Line(rect.xMax,rect.yMin, rect.xMax,rect.yMax);
            case Sides.D: return new Line(rect.xMin,rect.yMin, rect.xMax,rect.yMin);
