...
public static class GameUtils {
    ...
    static public void SendEmail(string emailTo, string subject, string body) {
    ...
    public static void ShowRateGamePopup() {
        #if PLATFORM_IOS
        bool success = UnityEngine.iOS.Device.RequestStoreReview();
        Debug.Log("Showing RequestStoreReview popup. Success: " + success);
        #endif
    }
    ...
    public static void LerpTransform(Transform tfToChange, Transform tfA,Transform tfB, float loc) {
        tfToChange.transform.position = Vector3.Lerp(tfA.position, tfB.position, loc);
        tfToChange.transform.rotation = Quaternion.Lerp(tfA.rotation, tfB.rotation, loc);
        tfToChange.transform.localScale = Vector3.Lerp(tfA.localScale, tfB.localScale, loc);
    }
    ...
    public static void SetOutlineAlpha (UnityEngine.UI.Outline obj, float alpha) {
        obj.effectColor = new Color (obj.effectColor.r,obj.effectColor.g,obj.effectColor.b, alpha);
    }
